...
namespace GenericApi.Model.Migrations
{
    ...
    [Migration("20210820135015_Laptop")]
            ...
            modelBuilder.Entity("GenericApi.Model.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 8, 20, 13, 50, 14, 265, DateTimeKind.Unspecified).AddTicks(9413), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            Dob = new DateTime(2021, 8, 20, 9, 50, 14, 266, DateTimeKind.Local).AddTicks(394),
                            DocumentType = 0,
